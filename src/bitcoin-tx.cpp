...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ovato-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ovato-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ovato transaction") + "\n" +
              "  ovato-tx [options] -create [commands]   " + _("Create hex-encoded ovato transaction") + "\n" +
              "\n";
