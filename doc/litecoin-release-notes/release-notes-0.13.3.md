Ovato Core version 0.13.3 is now available from:

  <https://download.ovato.org/ovato-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/ovato-project/ovato/blob/0.13/src/chainparams.cpp#L214).
